...
String lstatusMessage = "";
 ...
 {
	lusername = request.getParameter("name").trim();    
	lpassword = request.getParameter("password").trim();
	boolean isValid = true;	
		...
		if(lusername.equals("ngo") && lpassword.equals("ngo")) 
		{
...
<script src="ABC/script.js" language="javascript"></script>
	...
	<center><b><h4> NGO Login Form</h4></b></center>
