...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><b style="color:#660066;size:3">REQUESTED TRAINING INFORMATION</b></center><br><br>
   
    <%try{
   
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select * from fbreqtraining ");
