...
<script src="ABC/script.js" language="javascript"></script>
   ...
   <html> 
	...
	<center><b><h4>ADD CROPS INFORMATION</h4></b></center>
	
		
		
		<form  action="./crop" method="post">
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="400" height="200">
				<tr>
		<td>CROP NAME</td>
		<td><input type="text" name="cname" size="20" required/></td>
	</tr>
				<tr>
		                <td>STATE NAME</td> 
		...
		<option value="West Bengal">West Bengal </option>
				...
				<tr>
		<td>DISTICT NAME</td>
		<td><input type="text" name="distname" size="20" required/></td>
	</tr>
	<tr>
		<td>SEASON</td>
		<td><input type="text" name="season" size="20" required/></td>
	</tr>
				<tr>	
		                 <td align="right"><input type="submit" name="submit" value="Add" size="20"/></td>
