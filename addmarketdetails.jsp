  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <pre>
               ...
               <form action="./market" method="post">
                <center><h3>ADD MARKET DETAILS</h3></center>
		...
		<table align="center" border="1" bordercolor="pink">
		 <tr align="center"><td><span class="style23">District:</span></td>
		 <td><input type="text" name="distname"/></td></tr>
		  <tr><td><span class="style23">Market Area:</span></td>
		 <td> <input type="text" name="market"></td></tr>
		  </table>
