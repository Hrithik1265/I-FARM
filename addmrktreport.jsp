...
<script src="ABC/script.js" language="javascript"></script>
 ...
 <form action="./marketreport" method="post">
  <center><h3>ADD MARKET REPORT</h3></center>
  <table border=2 cellspacing=3 color="red">
   <tr><td><b>CROP NAME</b></td>
       <td><input type="text" name="cropname"/></td>
   </tr>
    <tr><td><b>ARRIVAL MODEL</b></td>
       <td><input type="text" name="arrivals"/></td>
   </tr>
   
   <tr><td><b>MODEL PRICE(rs/kg)</b></td>
       <td><input type="text" name="modelprice"/></td>
   </tr>
    <tr><td><b>UNITS OF ARRIVALS(in kgs)</b></td>
       <td><input type="text" name="unitsofarrivals"/></td>
   </tr>
   <tr><td><b>MARKET AREA</b></td>
   <td><select name="mrktarea">
   <option>--select--</option>
   <%
   Connection connection=DbConnection.getConnection();
   PreparedStatement ps=connection.prepareStatement("select marketarea from fbmarketdetails");
  ResultSet rs=ps.executeQuery();
   while(rs.next())
   {
   %>
   <option value="<%=rs.getString("marketarea") %>"><%=rs.getString("marketarea") %></option>
   <%
   }
   %>
   </select></td></tr>
   <tr><td><b>MARKET PRICE PER UNIT (rs/kg)</b></td>
       <td><input type="text" name="unitprice"/></td>
   </tr>
   <tr><td><b>MIN PRICE(in rupes)</b></td>
   ...
   <option value="d">D</option>
    ...
    <tr><td><b>VARIETY</b></td>
       <td><input type="text" name="variety"/></td>
   </tr>
    <tr><td><b>MAX PRICE(in rupes)</b></td>
