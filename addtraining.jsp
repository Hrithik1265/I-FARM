...
<script src="ABC/script.js" language="javascript"></script>
    ...
    <tr align="center"><td bgcolor="#336600">
   ...
   <html> 
	...
	<center><b><h4> ADD TRAINING INFORMATION</h4></b></center>
	
		
		
		<form  action="./addtraining" method="post">
		<table cellspacing=2 align="center" bgcolor="33FFCC" width="400" height="200">
				<tr>
		<td>TITLE</td>
		<td><input type="text" name="title" size="20" required/></td>
				...
				<tr>
		                <td>DESCRIPTION</td> 
		                <td><textarea rows="5" cols="22" name="desc"></textarea>
		             
				</tr>
				<tr>
		<td>SCHDULE</td>
		<td><input type="text" name="schdule" size="20" required/></td>
	</tr>
<tr>
		<td>STATUS</td>
