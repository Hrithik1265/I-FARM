...
//s.putValue("uname", username);
String uname=s.getValue("uname").toString();
%>
  <form action="./adminsendmsg" method="post">
    <table width="400" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
    <%s.putValue("uname", uname); %>
<tr>
<td >USERNAME</td><td><%=uname %></td></tr>
<tr><td>SUBJECT</td><td><textarea rows="2" cols="32" name="sub"></textarea></td></tr>
<tr><td>MESSAGE BODY</td><td><textarea rows="3" cols="32" name="msgbody"></textarea></td></tr>
<tr><td><input type="submit" name="submit" value="Send"/></td><td><input type="reset" name="reset"/></td></tr>
