...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
   ...
   String name=s.getValue("uname").toString();
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select msgdate,subject,description,sendto from fbmessage where username=? ");
...
<td width="300"BGCOLOR="YELLOW">SENDTO</td>
