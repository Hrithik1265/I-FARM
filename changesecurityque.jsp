...
function fncSubmit(squest,nsquest)
{

if(document.ChangeSequrityQueForm.squest.value == "0")
{
	alert('Please select old security question');
	return false;

} 

if(document.ChangeSequrityQueForm.nsquest.value == "0")
{
alert('Please select new security question');
...
document.ChangeSequrityQueForm.submit();
}
</script> </body>
<html><head>
...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
	...
	<center><b><h4>Reset Security Question</h4></b></center>
		...
		<form name="ChangeSequrityQueForm" method="post" action="./sque" OnSubmit="return fncSubmit();">

		<!-- <center><h3 style="color:#F00; width:300px;"></h3></center> --> 
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="325" height="70">
				      <tr>
		                <td ><font color="darkgreen"> Login Name</font></td></tr> 
		               <tr>
		               <td><input type="text" name="name" size="20" required/></td>
				     </tr>
				<tr>
		                <td><font color="darkgreen">Previous Security question</font></td> </tr>
		               <tr><td><select name="squest">
				...
				<tr>
		               <td><font color="darkgreen">Previous Secret Answer</font></td></tr> 
		               <tr><td><input type="text" name="sanswer"  size="20" required/></td>
				</tr>
				<tr>
				<td><font color="darkgreen">New Security question</font></td> </tr>
		               <tr><td><select name="nsquest">
		                             <option value="0">--select--</option>
                                    <option value="1">What is your favorite pastime?</option>
                                    <option value="2">Who was your childhood hero?</option>
                                    <option value="3">What was the name of your first school?</option>
                              ...
                              <tr>
		               <td><font color="darkgreen">New Secret Answer</font></td></tr> 
		               <tr><td><input type="text" name="nsanswer"  size="20" required/></td>
				</tr>
				<tr>
		                <td>
		                <%String var="";
		                String var1="";
	if(null!=request.getParameter("changesecurityque"))
		{
		 var=request.getParameter("changesecurityque");
		%>
		                <font color="red"><p><%=var %></p></font></td></tr> 
<%
		}
	else if(null!=request.getParameter("changesecurityque1"))
	{
		 var1=request.getParameter("changesecurityque1");
		 %>		
		<tr><td><b><%=var1 %></b></td></tr> 
<%
		}%>
