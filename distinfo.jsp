...
<script src="ABC/script.js" language="javascript"></script>
    ...
    <table align=center width="700" height="339">
    <tr align="center"><td bgcolor="#c1DDD7">
    
   <br>

 <form action="./Distinfo" method="post">
  <center><h3>ADD DISTRICT INFO</h3></center>
  ...
  <tr>
   ...
   <tr><td align="right"> <input type="submit" value="send"></td>
    <td align="center"><input type="submit" value="clear"></td></tr>
