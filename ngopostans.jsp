...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    </tbody></table></td><td width="700" align="center" valign="top">
     <%
     String query="";
    String qid ="";
   /* HttpSession s=request.getSession();
   qid=s.getValue("qid").toString();*/
   qid=request.getQueryString();
   System.out.println(qid);
   HttpSession s=request.getSession();
   s.putValue("qid", qid);
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select  * from fbquery where quaryid='"+qid+"'");
  ResultSet rs=ps.executeQuery();
   ...
   if(rs.next())
  {
	  query= rs.getString("quary");
	  s.putValue("query",query);
   
   %>
<tr><td>QUERY<b>:<%=rs.getString("quary")%><br><br></b>Answer&nbsp;<b>:<%=rs.getString("ans")%></b><br>
<% }
    Connection connection1=DbConnection.getConnection();
    PreparedStatement pst=connection1.prepareStatement("select  ans from fbpostansquery where queryid='"+qid+"'");
  ResultSet rs1=pst.executeQuery();
  while(rs1.next())
  {
%><b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<%=rs1.getString("ans")%></b><br>

<%} %>
</td></tr>
	 </table>

<form action="./ngopostans" method="post">
 <table width="500" border="1" cellspacing="4" cellpadding="4" ALIGN="CENTER"  > 
 <tr><td>Post Ans</td><td><textarea rows="8" cols="62" name="ans" required></textarea></td></tr>
 <tr><td>Ans By</td><td><input type="text" name="ansby" required /></td></tr>
 <tr><td></td><td align="center"><input type="submit" name="sumit" value="Post"><input type="reset" name="reset" value="clear"></td>
