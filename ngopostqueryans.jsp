...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>VIEW/POST YOUR ANSWERS HERE</h3></center>
    <%
    String qid ="";
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select  * from fbquery");
  ResultSet rs=ps.executeQuery();
   %>
   <table width="500" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
<tr>

<td width="300" BGCOLOR="YELLOW">QUERY</td>
<td width="300"BGCOLOR="YELLOW">POSTED DATE</td>
<td width="300"BGCOLOR="YELLOW">VIEW ANSWER</td>
<td width="300"BGCOLOR="YELLOW">ANSWER BY</td>
<td width="300"BGCOLOR="YELLOW">POST ANSWER</td>
   ...
   while(rs.next())
  {
 /*qid = rs.getString("quaryid");
   HttpSession s=request.getSession();
   s.putValue("qid", qid);
   System.out.println("postans.jsp'"+qid+"'");*/
   %>
<tr >
	<td><%=rs.getString("quary")%></td>
	<td><%=rs.getString("postdate")%></td>
	<td><%=rs.getString("ans")%>..</td>
	<td><%=rs.getString("ansby")%>..</td>
	<td><a href="ngopostans.jsp?<%= rs.getString("quaryid")%>">Post/View answers</a>
