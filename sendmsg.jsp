...
<script src="ABC/script.js" language="javascript"></script>
   ...
   <html> 
	...
	<center><b><h4>SEND MESSAGE</h4></b></center>
		...
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="400" height="200">
				<tr>
		<td>SUBJECT</td>
		<td><input type="text" name="sub" size="20" required/></td>
	</tr>
				<tr>
		                <td>MESSAGE BODY</td> 
		               <td><textarea rows="5" cols="22" name="msgbody"></textarea>
		...
		<option value="NGO">NGO</option></select></td>
	</tr>
	
				<tr>	
		                 <td align="right"><input type="submit" name="submit" value="SEND" size="20"/></td>
