...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>CROPS IN <%=soilname %></h3></center>
    <%
...
<center><h3>no fertilizers updated to  <%=soilname %> </h3></center>
<%} 
else
{%>
...
<td width="300" BGCOLOR="YELLOW">NITROGEN</td>
<td width="300"BGCOLOR="YELLOW">PHOSPOROUS</td>
<td width="300"BGCOLOR="YELLOW">COFFECREMER</td>
