...
<script src="ABC/script.js" language="javascript"></script>
   ...
   <html> 
	...
	<center><b><h4> REQUEST FOR TRAINING INFORMATION</h4></b></center>
	
		
		
		<form  action="./reqtraining" method="post">
		...
		<td><input type="text" name="title" size="20" required/></td>
				...
				%>
				  <font color="blue"><%=var %></font></td></tr>
				
				<tr>	
		                 <td align="right"><input type="submit" name="submit" value="Request" size="20"/></td>
