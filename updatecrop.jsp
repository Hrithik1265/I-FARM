d<%@page import="java.sql.ResultSet"%>
...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>UPDATE CROP INFOMATION</h3></center>
    <%
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select * from fbcrop");
...
<td width="300" BGCOLOR="YELLOW">DIST NAME</td>
...
<td><a href="updatecrop1.jsp?<%=rs.getString("cropname")%>">update</a></td>
<%} %>
</tr>
</table>
</td>
