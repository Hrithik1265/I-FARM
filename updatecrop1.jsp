...
<script src="ABC/script.js" language="javascript"></script>
 ...
 <form action="./updatecrop" method="post">
  <center><h3>UPDATE CROP INFORMATION</h3></center>
  <table border=2 cellspacing=3 color="red">
  <%
  String a,b,c,d="";
  Connection connection=DbConnection.getConnection();
  String cropname=request.getQueryString();
  PreparedStatement ps=connection.prepareStatement("select * from fbcrop where cropname='"+cropname+"'");
  ResultSet rs=ps.executeQuery();
  
  
  if(rs.next())
  {
  a=rs.getString("statename");
  b=rs.getString("dist");
  c=rs.getString("cropname");
  d=rs.getString("season");
 %>
 
   <tr><td><b>STATE NAME</b></td>
    <td> <%=a%></td></tr>
   
  <tr> <td><b>DIST NAME</b></td> <td> <%=b%></td></tr>
  
   <tr> <td><b>CROP NAME</b></td> <td> <textarea name="cropname" ><%=c%></textarea></td></tr>
  
   <tr> <td><b>SEASON</b></td> <td> <textarea name="season" ><%=d%></textarea></td></tr>
   
 
   <% }
  %>
 <tr align="center"><td align="center"><input type="submit" value="update">
