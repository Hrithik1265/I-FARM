...
<script src="ABC/script.js" language="javascript"></script>
 ...
 <form action="./updatefert" method="post">
  ...
  PreparedStatement ps=connection.prepareStatement("select * from fbfertilizer where cropname='"+cropname+"'");
  ResultSet rs=ps.executeQuery();
  while(rs.next())
  {
	String  c=rs.getString("cropname");
	 HttpSession s=request.getSession();
	 s.putValue("cropname", c);
  %>
   <tr><td><b>soilname</b></td>
  <td><%= rs.getString("soilname") %> </td></tr>
   <tr><td><b>crop type</b></td>
   <td> <%=rs.getString("type")%></td></tr>
    <tr><td><b>crop name</b></td>
    <td> <%=rs.getString("cropname")%></td></tr>
   <tr><td><b>Nitrogen(N)</b></td>
   <td> <textarea name="nitrogen" ><%=rs.getString("nitrogen")%></textarea></td></tr>
   <tr><td><b>Phosporous(P2O5)</b></td>
   <td> <textarea name="phosporous" ><%=rs.getString("phosporous")%></textarea></td></tr>
   <tr><td><b>CoffeeCreamer(K2O)</b></td>
   <td> <textarea name="coffee_cremer" ><%=rs.getString("coffee_cremer")%></textarea></td></tr>
   <tr><td><b>Use Fertilizer for Heactor</b></td>
   <td> <textarea name="fert_per_hector" ><%=rs.getString("fert_per_hector")%></textarea></td></tr>
   <tr><td><b>Cost of Fertilizer</b></td>
   <td> <textarea name="cost_of_fert" ><%=rs.getString("cost_of_fert")%></textarea></td></tr>
   <tr><td><b>Use Fertilizer for Year</b></td>
   <td> <textarea name="use_fert_for_year" ><%=rs.getString("use_fert_for_year")%></textarea></td></tr>
   <tr><td><b>Use Fertilizer for State</b></td>
   <td> <textarea name="use_fert_for_state" ><%=rs.getString("use_fert_for_state")%></textarea></td></tr>
   <tr><td><b>Use Fertilizer for Crops</b></td>
   <td> <textarea name="use_fert_for_crops" ><%=rs.getString("use_fert_for_crops")%></textarea></td></tr>
   <tr><td><input type="submit" value="update">
   <input type="submit" value="clear"></td></tr>
