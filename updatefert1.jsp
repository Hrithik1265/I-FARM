...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>UPDATE FERTILIZER</h3></center>
    <%
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select * from fbfertilizer");
    ResultSet rs=ps.executeQuery();
    
    %>
    <table width="300" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
<tr>
<td width="300">SOILNAME</td>
<td width="300">CROPTYPE</td>
<td width="300">CROPNAME</td>
<td width="300">NITROGEN</td>
<td width="300">P2O5</td>
<td width="300">K2O</td>
<td width="300">FERT PER HECTOR</td>
<td width="300">COST OF FERT</td>
<td width="300">USAGE PER YEAR</td>
<td width="300">USAGE PER STATE</td>
<td width="300">USAGE PER CROPS</td>
</tr>
<%
while(rs.next())
{%>
<tr >
<td><%=rs.getString("SOILNAME")%></td>
<td><%=rs.getString("TYPE")%></td>
<td><%=rs.getString("CROPNAME")%></td>
<td><%=rs.getString("nitrogen")%></td>
<td><%=rs.getString("phosporous")%></td>
<td><%=rs.getString("coffee_cremer")%></td>
<td><%=rs.getString("fert_per_hector")%></td>
<td><%=rs.getString("cost_of_fert")%></td>
<td><%=rs.getString("use_fert_for_year")%></td>
<td><%=rs.getString("use_fert_for_state")%></td>
<td><%=rs.getString("use_fert_for_crops")%></td>
<td><a href="updatefert.jsp?<%=rs.getString("cropname")%>">update</a></td>
<%} %>
</tr>
</table>
</td>
