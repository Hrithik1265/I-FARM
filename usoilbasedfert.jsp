...
<center><b><font COLOR="BLUE" size="3">VIEW SOIL BASED FERTILIZER</font></b></center><br><br>
	
		
   <form  action="usoilbasedfert1.jsp" method="post">
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="500" height="100">
				<tr>
		                <td><font color="green">SOIL NAME</font></td> 
		               <td><select name="soil">
		               <%
		               Connection connection=DbConnection.getConnection();
		               PreparedStatement  ps=connection.prepareStatement("select * from soil_ident");
				...
				<tr>	
		                 <td align="center"><input type="submit" name="submit"  size="20"/></td>
