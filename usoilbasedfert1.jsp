...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>Fertilizers for crops <%=soilname.toUpperCase() %></h3></center>
    <%
    
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select * from fbfertilizer where soilname='"+soilname+"'");
   ResultSet  rs=ps.executeQuery();
   
    if(!rs.next())
{%>

<center><h3>No fertilizers updated to  <%=soilname.toUpperCase() %> </h3></center>
<%} 
else
{%>
 <table width="500" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
<tr>
<td width="300" BGCOLOR="YELLOW">CROP NAME</td>
<td width="300" BGCOLOR="YELLOW">NITROGEN(gms)</td>
<td width="300"BGCOLOR="YELLOW">PHOSPOROUS(gms)</td>
<td width="300"BGCOLOR="YELLOW">COFFECREMER(gms)</td>
<td width="300"BGCOLOR="YELLOW">FERT PER HECTOR(kg)</td>
<td width="300"BGCOLOR="YELLOW">COST OF FERT(rs/kg)</td>
</tr>
	<tr >
