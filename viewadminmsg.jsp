...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
   ...
   <%
    ...
    PreparedStatement ps=connection.prepareStatement("select msgdate,username,subject,description from fbmessage where sendto=? ");
...
<td width="300" BGCOLOR="YELLOW">DATE</td>
<td width="300"BGCOLOR="YELLOW">USERNAME</td>
<td width="300"BGCOLOR="YELLOW">SUBJECT</td>
<td width="300"BGCOLOR="YELLOW">MESSAGE BODY</td>
<td width="300"BGCOLOR="YELLOW">RESPONSE</td>
...
%>
	...
	<td><a href="adminsendmsg.jsp">Reply</a></td>
