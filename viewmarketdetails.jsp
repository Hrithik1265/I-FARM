...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><h3>VIEW MARKET DETAILS</h3></center>
    <%
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select * from fbmarketdetails");
    ResultSet rs=ps.executeQuery();
    
    %>
    <table width="600" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
<tr>
<td width="300" bgcolor="yellow" >STATE NAME</td>
<td width="300" bgcolor="yellow">DISTICT NAME</td>
<td width="300" bgcolor="yellow">MARKET</td>
</tr>
<%
while(rs.next())
{%>
