...
.style27 {
  ...
  <body leftmargin="0" topmargin="0" bgcolor="#c1DDD7" marginheight="0" marginwidth="0">
    ...
    <center><b style="color:#660066;size:3">TRAINING INFORMATION</b></center><br><br>
   
    <%try{
   
    Connection connection=DbConnection.getConnection();
    PreparedStatement ps=connection.prepareStatement("select title,description,schdule,status from fbtraining ");
ResultSet rs=ps.executeQuery();
%>
 <table width="500" border="2" cellspacing="2" cellpadding="3" ALIGN="CENTER"  >
<tr>

<td width="300" BGCOLOR="YELLOW">TITLE</td>
<td width="300"BGCOLOR="YELLOW">DESCRIPTION</td>
<td width="300"BGCOLOR="YELLOW">SCHEDULE</td>
<td width="300"BGCOLOR="YELLOW">STATUS</td>
